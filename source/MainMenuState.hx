...
{
	public static var testVersion:String = 'idk'; //my mod
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Hilo Engine v" + testVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 20, FlxColor.PINK, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
