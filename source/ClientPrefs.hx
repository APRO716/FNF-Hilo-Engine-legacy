...
class ClientPrefs {
	...
	public static var accuracy:String = 'Hiro_mod';
	public static var combocolor:Bool = false;
	...
	public static var showTiming:Bool = true;
	...
	public static var epicWindow:Int = 20;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.combocolor = combocolor;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.combocolor != null) {
			combocolor = FlxG.save.data.combocolor;
		}
