...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		/*["Cool Skill",					"Beat 'First-rapping' ",							'first_song',				false],
		["Play osu! mania too much",	"Beat 'First-rapping' with no Misses.",				'first_song_FC',			false],
		["How many miss lol",			"Beat 'Being-serious' ",							'second_song',				false],
		["Cheater!!!!!! >:(",			"Beat 'Being-serious' with no Misses.",				'second_song_FC',			false],
		["NOOB lol",					"Beat Any songs with Botplay.",						'bot_play',					false],*/
